...
class ShortDeclineFlipStrategy(IStrategy):
    ...
    minimal_roi = {"0": 100}
    stoploss = -0.20  # 固定止损 -20%（10x杠杆下 = 价格跌2%触发）
    ...
    # ── 移动止盈参数（相对加权均价）──
    trail_activate = 0.02  # 盈利方向偏离均价 2% 激活移动止盈
